...
import org.asn1gen.parsing.asn1.ast.ModuleDefinition
import scala.collection.immutable._
import scala.io.Source

case class Model (modules: HashMap[String, ModuleDefinition]) extends Asn1Parser {
    ...
    file.openPrintStream { ps =>
      ...
      parse(root, text) match {
        case Success(moduleDefinition, _) =>
          ...
          Model(modules + (name -> moduleDefinition))
        case failure =>
