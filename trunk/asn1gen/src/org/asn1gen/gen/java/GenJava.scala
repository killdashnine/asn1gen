...
class GenJava(model: JavaModel, outDirectory: File, namespace: Option[String], moduleName: String) {
  ...
  def generateModelPackageAndImports(implicit module: Module, out: IndentWriter): Unit = {
    out << "/* This file was generated by asn1gen */" << EndLn
    out << EndLn
    out << "package " << model.namespace.foldRight("model." + module.name)(_ + "." + _) << ";" << EndLn
    out << EndLn
  ...
  def generateType(namedType: NamedType)(implicit module: Module, out: IndentWriter): Unit = {
    generateModelPackageAndImports(module, out)
    generate(namedType)
  }
