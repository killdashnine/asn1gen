...
public class TLV {
  public static void dump2(final PrintStream out, final ByteArrayWindow window) {
    try (final IndentWriter indentWriter = new IndentWriter(out)) {
      dump2(indentWriter, window);
    }
  }
  
  public static ByteArrayWindow dump2(final IndentWriter out, final ByteArrayWindow window) {
                    ...
                    case CONSTRUCTED:
                      if (true) {
                        ...
                        while (childWindow.length > 0) {
                          childWindow = dump2(out, childWindow);
                        }
                        break;
                      }
                    }
  ...
  public static void main(final String[] args) {
    dump2(System.out, ByteArrayWindow.to(new byte[] { 0x31, 0x0c, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x0a, 0x01, 0x00, 0x01, 0x01, 0x00 }));
  }
}
