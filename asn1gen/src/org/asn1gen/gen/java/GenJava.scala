...
class GenJava(outDirectory: File, moduleName: String) {
  ...
  def generatePackageAndImports(module: Module)(implicit out: IndentWriter): Unit = {
    out << "/* This file was generated by asn1gen */" << EndLn
    out << EndLn
    out << "package " << moduleName << ";" << EndLn
    out << EndLn
  ...
  def generateType(module: Module, namedType: NamedType)(implicit out: IndentWriter): Unit = {
    generatePackageAndImports(module)
    generate(namedType)
  }
  
  def generateValues(module: Module)(implicit out: IndentWriter): Unit = {
    generatePackageAndImports(module)
  ...
  def generate(namedValue: NamedValue)(implicit out: IndentWriter): Unit = {
    out.trace("/*", "*/")
    namedValue match {
  ...
  def generate(namedType: NamedType)(implicit out: IndentWriter): Unit = {
  ...
  def generate(builtinType: ast.BuiltinType, assignmentName: String)(implicit out: IndentWriter): Unit = {
  ...
  def generateEnumeratedValues(enumerations: ast.Enumerations, assignmentName: String)(implicit out: IndentWriter): Unit = {
    enumerations match {
      case ast.Enumerations(ast.RootEnumeration(ast.Enumeration(items)), extension) => {
        var index = 0
        items foreach {
  ...
  def generate(assignmentName: String, setOfType: ast.SetOfType)(implicit out: IndentWriter): Unit = {
    val safeAssignmentName = safeId(assignmentName)
    setOfType match {
  ...
  def generateSequenceFieldDefines(sequenceName: String, list: List[ast.ComponentType])(implicit out: IndentWriter): Unit = {
    out.trace("/*", "*/")
    list foreach {
      case ast.NamedComponentType(
        ast.NamedType(ast.Identifier(identifier), _type),
  ...
  def generateSequenceFieldParameters(
      sequenceName: String, list: List[ast.ComponentType])(implicit out: IndentWriter): Unit = {
    out.trace("/*", "*/")
    var firstTime = true
    list foreach {
      case ast.NamedComponentType(
  ...
  def generateSequenceParameters(list: List[ast.ComponentType])(implicit out: IndentWriter): Unit = {
    out.trace("/*", "*/")
    var firstTime = true
    list foreach {
      case ast.NamedComponentType(
  ...
  def generateSimpleGetters(rootAlternativeTypeList: ast.RootAlternativeTypeList)(implicit out: IndentWriter): Unit = {
    out.trace("/*", "*/")
    rootAlternativeTypeList match {
      case ast.RootAlternativeTypeList(ast.AlternativeTypeList(namedTypes)) => {
        namedTypes foreach { namedType =>
  ...
  def generateSimpleGetters(namedType: ast.NamedType)(implicit out: IndentWriter): Unit = {
    namedType match {
      case ast.NamedType(
        ast.Identifier(name),
        _type)
